...
function LoginCtrl(UsuarioService, $location, $cookies) {
        ...
        self.login = function () {
            console.log("passou self login");
            console.log(self.usuario);
           // $location.path('views/dashboard_1.html');
            UsuarioService.getUsuarioById(1).success(function (data) {
                console.log("passou self login 2");
                console.log(data);
                if (data.logado == "true") {
                    console.log(self.usuario);
                    UsuarioService.session(self.usuario);
                    console.log("cookie criado");
                    $location.path('perfil/perfil_usuario');
                } else {
                    $location.path('/login?erro=1');
                }
...
function LogoutCtrl(UserService, $scope, $cookieStore) {
    //$scope.cookieValue = $cookies.text;
